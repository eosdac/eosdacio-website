...
Если требование набрало достаточное количество голосов от хранителей после завершения работы с учетом текущей конфигурации, то работник может вызвать действие, которое вызовет отправку платежа работнику. На данный момент в eosDAC средства отправляются на счет сервисной компании, но фактически они выплачиваются напрямую работнику за его услуги.
