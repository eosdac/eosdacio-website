...
* Уволить кандидата (`firecand`): Это действие в настоящее время может быть вызвано только избранными хранителями с помощью мультиподписи, чтобы удалить кандидата с плохой репутацией или поведением. Это действие также имеет возможность заблокировать токены кандидатов, если они еще не заблокированы.
