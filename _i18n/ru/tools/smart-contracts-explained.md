...
* Отправить хранителя в отставку (`resigncust`): Это действие выполняется активным хранителем, который хотел бы уйти с должности действующего хранителя. Это отменит их регистрацию в качестве кандидата и заменит хранителя следующим в списке по количеству голосов кандидатом.
